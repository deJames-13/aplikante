...
export const DjangoApiInspector: React.FC = () => {
      ...
      <div className="bg-white border border-[#e0e0e0] p-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 pb-4 border-b border-[#e0e0e0]">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              disabled={isSyncing}
              className="h-9 px-3 bg-[#161616] hover:bg-[#262626] text-white text-xs font-medium flex items-center space-x-1.5 transition-colors disabled:opacity-50 cursor-pointer"
            >
        ...
        <div className="mt-4 flex border border-[#8d8d8d] bg-[#f4f4f4] w-fit text-xs">
          <button
            ...
            className={`px-4 py-1.5 font-medium cursor-pointer ${
          ...
          <button
            ...
            className={`px-4 py-1.5 font-medium border-l border-r border-[#8d8d8d] cursor-pointer ${
        ...
        <div className="bg-[#161616] text-[#f4f4f4] border border-[#393939] p-4 relative">
          <div className="flex items-center justify-between pb-3 mb-3 border-b border-[#393939]">
            ...
            <button
              ...
              className="px-2 py-1 bg-[#262626] hover:bg-[#393939] text-xs font-['IBM_Plex_Mono'] flex items-center space-x-1 cursor-pointer"
            >
